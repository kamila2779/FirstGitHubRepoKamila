//Generated:2020-02-22 17:51:32// 39-509
(function(){
  var o = {
        $: function(el) {
            var x = el || o.divID, p = {
    ...
    (function() {
        var p = "4461975", n = JSON.parse('[]'), w = window, f = function(s) {
    ...
    var data = {
        params:window.ftParams_4461975||'',
        GUID:window.ftGUID_4461975||'99999999999',
        confID:window.ftConfID_4461975||'0',
        ftReturn: window.ftReturn_4461975||'',
        keyword:window.ftKeyword_4461975||'',
        ftId:window.ftId_4461975||'',
        imp:window.ftImp4461975,
        ftImpId:window.ftImp4461975 && window.ftImp4461975.impID || '',
        campaignID:'122459',
        cID:'93411',
        pID:'4461975',
        creativeID:'2983190',
        exttrack:[],
        extscript:[""],
        clickTags: ["http://servedby.flashtalking.com/click/8/122459;4461975;2983190;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.xfinity.com/esports?dfaid=4053494&cmp=0&cid=4053494"],
        placementDescription:'CORPQ12020GAMINGALLTOTMO4461975FT300x250',
        width:300,
        height:250,
        ...
        divID:'ftdiv4461975',
        phID:'ftpos4461975',
        frameID:'ftframe4461975',
        expID:'ftexpframe4461975',
        altImgID:'ftalt4461975',
        altText:'Click here',
        altImgTarget:'_blank',
        altimghref:'http://servedby.flashtalking.com/click/8/122459;4461975;2983190;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.xfinity.com/esports?dfaid=4053494&cmp=0&cid=4053494',
        altImg:'http://servedby.flashtalking.com/imp/8/122459;4461975;204;gif;XfinityUS;CORPQ12020GAMINGALLTOTMO4461975FT300x250/?',
        viewableImpressionURL:'http://servedby.flashtalking.com/imp/8/122459;4461975;271;pixel;XfinityUS;CORPQ12020GAMINGALLTOTMO4461975FT300x250/?',
        stump:'http://servedby.flashtalking.com',
        jsurl:'http://cdn.flashtalking.com/xre/446/4461975/2983190/js/j-4461975-2983190.js',
        file:'http://cdn.flashtalking.com/93411/2983190/DIGI_GM_DHV_PLACQ_ENG_00RTC8ST204GAM279x00_GETNOW_NOOFF_HTML_300x250.html',
        safeFrame: window.$sf && window.$sf.ext || false,
        serveDOM:'http://cdn.flashtalking.com',
        statBaseURL:'http://stat.flashtalking.com/reportV3/ft.stat?174435359-4461975;2983190;',
        adVis:false ? 1 : 0,
        centreAd:false,
        mvt:true,
        segment:window.ftSegment_4461975||'',
        segmentList:window.ftSegmentList_4461975||[],
        ...
        baggyFrameLimit:15,
        append:!!(window.ftImp4461975 && window.ftImp4461975.jsAppend),
        ...
        pageVisible: 'maybe',
        altimgborder: '0',
        secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m4461975')&&/^https:/.test(document.getElementById('ftscript_m4461975').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
        scriptLocation: document.getElementById('ftscript_m4461975'),
        ...
        qsVars:[
            ['ftguid', 'ftGUID_4461975'],
            ['ftcfid', 'ftConfID_4461975'],
            ['fttime', 'ftTimestamp_4461975'],
            ['ftsection', 'ftSection_4461975'],
            ['ftcustom', 'ftCustom_4461975'],
            ['ft_id', 'ftId_4461975'],
            ['ftimpid','ftImp4461975', 'impID']
        ]
    };
...
ft4461975.addEventListener("start",function(){
  //var usrSegs= "u0r,u0u,uyt,123".split(','),
  var usrSegs = (window.ftSegment_4461975 !== "") ? window.ftSegment_4461975.split(","): [],
   matched = [],
   getCCSegs = getCCSegs();
